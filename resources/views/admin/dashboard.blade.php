...
<head>
    <!-- Basic Page Info -->
    <meta charset="utf-8" />
    <title>Coding Thunder || Home</title>
...
<body>
    ...
    <div class="main-container">
        <div class="pd-ltr-20">
            <div class="card-box pd-20 height-100-p mb-30">
                <div class="row align-items-center">
                    <div class="col-md-4">
                        <img src="{{ url('/') }}/backend/assets/vendors/images/banner-img.png" alt="" />
                    </div>
                    <div class="col-md-8">
                        ...
                        <p class="font-18 max-width-600 text-justify" style="color: rgb(0, 0, 0);">
                            Admin panel is the most important part of any website to
                            manage all data of the site from one location. The first
                            part of implementing admin panel for the e-commerce site
                            that was shown in the previous five tutorials has been
                            described in this tutorial step by step.
                        </p>
                    </div>
                </div>
            </div>
        ...
        <div class="xs-pd-20-10 pd-ltr-20">
            <div class="title pb-20">
                <h2 class="h3 mb-0 text-primary">Hospital Overview</h2>
            </div>
            <div class="row pb-10">
    ...
    <script src="{{ url('/') }}/backend/assets/vendors/scripts/dashboard3.js"></script>
