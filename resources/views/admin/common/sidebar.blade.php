...
<div class="left-side-bar">
    <div class="brand-logo">
        <a href="{{ url('admin/dashboard') }}">
            <img src="{{ url('/') }}/backend/assets/logo/logo.jpg" alt="" class="dark-logo" height="80px;" width="80px;"/>
            <img src="{{ url('/') }}/backend/assets/logo/logo.jpg" alt="" class="light-logo" height="80px;" width="80px;" />
        </a>
